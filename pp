...
SRCM = main.c \$
		...
		utils/expand_hard2.c parsing/herdoc_handler.c parsing/process_lexemes.c parsing/process.c parsing/last_del.c parsing/herdoc_var.c parsing/herdoc_utils.c parsing/herdoc_var_utils.c parsing/herdoc_val_utils.c parsing/token_utils.c utils/replace_vars_1.c  utils/replace_vars_2.c utils/ft_realloc.c utils/expand_utils.c utils/expand_utils2.c utils/minishell_loop.c$
...
$
clean:$
	@echo "Cleaning upM-bM-^@M-& M-pM-^_M-'M-9 M-pM-^_M-'M-< M-pM-^_M-'M-= M-bM-^\M-("$
	@rm -f $(OBJS)$
	@make -C libft clean$
$
fclean: clean$
